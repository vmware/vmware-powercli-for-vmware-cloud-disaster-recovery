...
update-TypeData -TypeName "VMware.VCDRService.VmSummary" -DefaultDisplayPropertySet I  Name, Size, Vcdr_vm_id 
...
<#
        ...
        .PARAMETER Id
            The identifier of the cloud file system. 
        .EXAMPLE
            Get-VCDRCloudFileSystems -Name "cloud-backup-1"
        ...
        .EXAMPLE
            Get-VCDRCloudFileSystems -Id "dbd913aa-6cbe-11ec-9871-0a3e56ef2005"
            
            Description
            ----------- 
            This example shows recalling of any Cloud Files System that matches the given id
        .NOTES
            FunctionName    : Get-VCDRCloudFileSystems
            Created by      : VMware
            Date Coded      : 2022/02/20  
            Modified by     : VMware
            Date Modified   : 2022/02/20 16:12:10
    ...
    #>
Function Get-VCDRCloudFileSystems {
...
<#
       ...
       .PARAMETER CloudFileSystem
        ...
        .EXAMPLE
            $CloudFS=Get-VCDRProtectedSites -CloudFileSystem "dbd913aa-6cbe-11ec-9871-0a3e56ef2005"
            Get-VCDRProtectedSites -CloudFileSystem $CloudFS  
        ...
        .NOTES
            FunctionName    : Get-VCDRProtectedSites
            Created by      : VMware
            Date Coded      : 2022/02/20  
            Modified by     : VMware
            Date Modified   : 2022/02/20 16:12:10
...
Function Get-VCDRProtectedSites {
    [CmdletBinding(DefaultParameterSetName = 'Default')]
    Param(
...
<#
       ...
       .PARAMETER CloudFileSystem
        ...
        .NOTES
            FunctionName    : Get-VCDRProtectionGroups
            Created by      : VMware
            Date Coded      : 2022/02/20  
            Modified by     : VMware
            Date Modified   : 2022/02/20 16:12:10
    ...
    #> 
Function Get-VCDRProtectionGroups {
    [CmdletBinding(DefaultParameterSetName = 'Default')]
    Param(
        [Parameter( Mandatory = $true, ValueFromPipeline = $true, HelpMessage = "Cloud FileSystem")]
        [VMware.VCDRService.CloudFileSystem]  $CloudFileSystem,
...
Export-ModuleMember -Function Get-VCDRCloudFileSystems
Export-ModuleMember -Function Get-VCDRProtectedSites
Export-ModuleMember -Function Get-VCDRProtectionGroups
